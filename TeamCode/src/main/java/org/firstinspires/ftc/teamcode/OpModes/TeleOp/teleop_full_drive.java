...
// @Disabled
@TeleOp(name="teleop_full_drive", group="Linear Opmode")
public class teleop_full_drive extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad2.dpad_down) slides.decVelocity(1000);
            if (gamepad2.dpad_up) slides.incVelocity(1000);
